...
>
      ...
      <div className="relative z-10 px-6 text-white">
        ...
        <a 
          href="#contact" 
          className="bg-blue-600 text-white font-bold py-3 px-8 rounded-full text-lg hover:bg-blue-700 transition-transform transform hover:scale-105 duration-300 shadow-lg">
          {t.heroButton}
        </a>
      </div>
    </section>
